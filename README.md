...
------------------------------------------------------
  - https
    ...
    - EC2 제공 도메인 'http://example.invalid/' 사용하여 인증
  - 자동 배포
...
| [***](https://github.com/osy9536) | [***](https://github.com/dalcheonroadhead) | [***](https://github.com/oistmil) | [***](https://github.com/andongmin94) | [***](https://github.com/jiyeon2536) | [***](https://github.com/lhgeer2617) |
| ----- | ------ | ----- | ------ | ----- | ------ |
...
| ------------ | ---- | -------- |
| [***](https://github.com/osy9536) | 팀장, <br /> Backend Lead | - 유저 플로우 작성 <br> - 스프링 시큐리티 적용 <br> - JWT filter 적용 <br> - 공통 응답 API 작성 <br> - 공통 에러 응답 API 작성 <br> - 카카오 소셜 로그인 구현 <br> - 도감 관련 API 작성 <br> - 유저 데이터 관련 API 작성 <br> - 간단한 Front API 작성 <br> - Infra 구성 ( AWS RDS, EC2, Nginx Reverse Proxy, Jenkins Pipeline, Dockerfile) |
| [***](https://github.com/dalcheonroadhead) | 팀원, <br /> Backend | - WebSocket 채팅 서버 <br> - 롤 API 담당하여 명세서 작성 <br> - 롤 LOCAL API 이용한 크롤링 <br> - socket s3를 이용한 이미지 업로드 |
| [***](https://github.com/oistmil) | 팀원, <br /> Backend, <br /> PM  | - SSE 이용한 실시간 알림, 확성기 기능 구현(Backend SseEmitter 적용, Frontend EventSourcePolyfill 적용) <br> - 아이템샵 구입(칭호, 강제칭찬권, 확성기) 관련 API 작성 <br> - 칭호 관련 API 작성 <br> - 친구 관련 API 작성 <br> - JUnit 서비스단 단위 테스트 작성 |
| [***](https://github.com/andongmin94) | 팀원, <br /> Frontend Lead| - 일렉트론 포팅 및 개발 & PWA 포팅 <br> - 클라이언트 & 라이브 채팅창 연동 <br> - 선행기술 연구 <br> - UCC 제작 |
| [***](https://github.com/jiyeon2536) | 팀원, <br /> Frontend, <br /> 서기| - Notion 을 통해 협업 문서 관리 및 회의록 작성<br> - Figma 활용하여 디자인 및 와이어프레임 작성<br> - react-ga4 활용하여 google analytics 적용 <br> - 카카오 로그인 API 활용하여 회원가입 및 로그인 구현<br> - 도감, 댓글 CRUD 개발<br> - React-Query 사용하여 무한 스크롤 구현 <br> - UI, UX 개선  |
| [***](https://github.com/lhgeer2617) | 팀원, <br /> Frontend, <br /> 총무| - WebSocket 채팅 프론트 <br> - 웹 UI/UX <br> - PWA 반응형 모바일 UI |

...
export default function TitleBar() {
  ...
  return (
    <div className="fixed flex justify-end z-10 border rounded-xl" style={{ WebkitAppRegion: "drag", width: "100%", borderColor: "rgba(0, 0, 0, 0)", backgroundColor: "#262626" } as React.CSSProperties }>

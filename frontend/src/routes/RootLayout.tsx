  ...
  return (
    <>
      <main className={classes.page}>
        ...
        <div
          className={cn(classes.section_right, {[classes.electron_section_right]: typeof electron !== "undefined"    })}
        >
          {/* 네브바 */}
          { theme === "light" ? <nav className={classes.nav}>
            <div></div>
          ...
          </nav> : <nav className={classes.nav_dark}>
            <div></div>
